...
class NGREState extends FlxState
{
    ...
    override function create()
    {
		...
		super.create();
                ...
                var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('backgrounds/nighttimegamingremix'));
		bg.scrollFactor.x = 0;
