...
class SCState extends FlxState
{
    ...
    override function create()
    {
		...
		super.create();
                ...
                var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('backgrounds/silvercandy'));
		bg.scrollFactor.x = 0;
		...
		add(DisplayText);
                ...
                FlxG.sound.playMusic(Paths.music('Silver_Candy'), 1);
    }
